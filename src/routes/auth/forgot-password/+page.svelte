...
<Container width="w-5/12">
  ...
  <SignedOut let:auth>
    <div class="flex flex-col justify-between gap-3">
      <div>
        <Label class="block mb-2">Please enter the email of your account. We will send you and email with a password reset link.</Label>
        <Input label="Email" id="email" name="email" required placeholder="email@example.com" bind:value={email} />
        {#if emailError}
