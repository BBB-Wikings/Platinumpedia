<script lang="ts">
	...
	const { form, errors, constraints, enhance, message } = superForm<typeof loginSchema, Message>(
...
<form method="post" class="px-8 py-4" use:enhance>
	...
	<div class="text-sm font-medium flex justify-between">
		<span>
			Not registered?
			<a href="/auth/register" class="text-primary-500 hover:underline"> Create account </a>
		</span>

		<a href="/auth/forgot-password" class="hover:underline text-primary-500"> Forgot password? </a>
	</div>
</form>
